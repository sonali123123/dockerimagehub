...
# installed.
TCL_PREFIX='D:/Sonali_AI_Projects/Docker_Image/cicd\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Sonali_AI_Projects/Docker_Image/cicd\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Sonali_AI_Projects/Docker_Image/cicd\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Sonali_AI_Projects/Docker_Image/cicd\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Sonali_AI_Projects/Docker_Image/cicd\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Sonali_AI_Projects/Docker_Image/cicd\Library\lib\tclstub86.lib'
